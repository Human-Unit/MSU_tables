...
const en: Dict = {
  ...
  'journal.attendance.empty': 'No attendance records yet — use “Add attendance”.',
...
const ru: Dict = {
  ...
  'journal.attendance.empty': 'Пока нет записей о посещаемости — нажмите «Добавить посещаемость».',
