...
'field.status': 'Status',
  ...
  'journal.tourDatePrompt': 'Enter date for Tour {tour} of {subject}',
...
const ru: Dict = {
  ...
  'journal.tourLockedChanges': 'Заблокировано: достигнут лимит изменений',
  'journal.tourLockedPassed': 'Заблокировано: пройден на Туре {tour}',
  'journal.tour1': 'Тур 1 (Первичная попытка)',
  'journal.tour2': 'Тур 2 (Пересдача)',
  'journal.tour3plus': 'Тур {n} (Дополнительный)',
  'journal.avg': 'Ср.балл',
  ...
  'journal.tourDatePrompt': 'Введите дату для Тура {tour} по {subject}',
