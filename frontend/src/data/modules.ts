...
export const moduleConfigs: ModuleConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {name: 'password', label: 'field.password', type: 'text', required: true},
      {name: 'isActive', label: 'field.active', type: 'checkbox'},
    ],
  },
  {
  ...
  },
  {
    ...
    columns: [{key: 'day', label: 'col.day'}, {key: 'pair', label: 'col.pair'}, {key: 'student.fullName', label: 'col.student'}],
    fields: [
      ...
      {name: 'pair', label: 'field.pair', type: 'number', required: true, min: 1, max: 8},
      {name: 'sign', label: 'field.present', type: 'checkbox'},
      {name: 'isActive', label: 'field.active', type: 'checkbox'},
    ],
  },
  {
